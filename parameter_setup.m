function [dim_Psi,eta,fm,h,u_a,bpt,d2,sigma,varepsilon,e,n_mu,n_u,n_t,lx,ly,rx,um,v,dt,dti,tn,nsk,nsm,run_max,sp,skm,skk,sks] = parameter_setup()
    ...
    dim_Psi = 45; % the dimension of projection basis
    eta = [0.8, 1, 1.2]; % the scale factor of the variances of Gaussian functions
    ...
    fm = 15000; % peak value of Gaussian heat source
